...
with string parsing, static checks, and the Common Lisp `run` backend.
Native text lowering, precise roots, and the native collector are not implemented
yet; this is not a complete v0.6.0 implementation.
