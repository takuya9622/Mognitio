...
(deftest v04-typed-functions-and-order
  (dolist (source
            '("let subtotal :function(int,int):int= function(price: int, count: int): int { price * count }; let discounted :function(int):int= function(amount: int): int { amount - 20 }; discounted(subtotal(120, 3)) == 340"
              ...
              "let Void :function(int):int= function(never: int): int { let string = never; string }; Void(3) == 3"
...
(deftest v04-return-paths
  (dolist (source
            '("let f :function():int= function(): int { return 7; }; f() == 7"
              "let f :function(bool):int= function(b: bool): int { branch when{(b)=>{return 2;},else=>{3}} }; f(true) + f(false) == 5"
              "let f :function(bool):bool= function(b: bool): bool { branch when{(b)=>{return true;},else=>{return false;}} }; f(true) != f(false)"
              "let f :function(bool,int):int= function(stop: bool, n: int): int { let x: int = branch when{(stop)=>{return n;},else=>{n + 1}}; x * 2 }; f(true, 3) + f(false, 3) == 11"
              "let f :function():int= function(): int { return 2; }; let g :function():int= function(): int { f() + 3 }; g() == 5"
              "let pair :function(int,int):int= function(a: int, b: int): int { a + b }; let f :function():int= function(): int { pair(branch when{(true)=>{return 7;},else=>{return 8;}}, 1 / 0) }; f() == 7"
              "let f :function():int= function(): int { branch when{(branch when{(false)=>{return 7;},else=>{return 8;}})=>{1 / 0},else=>{2 / 0}} }; f() == 8"
              "let f :function():int= function(): int { (branch when{(true)=>{return 7;},else=>{return 8;}}) + 1 / 0 }; f() == 7"
              "let f :function():int= function(): int { 3 + branch when{(true)=>{return 7;},else=>{return 8;}} }; f() == 7"
              "let f :function():int= function(): int { -(branch when{(true)=>{return 7;},else=>{return 8;}}) }; f() == 7"
              "let f :function():int= function(): int { return branch when{(true)=>{return 7;},else=>{return 8;}}; }; f() == 7"
              "let f :function(bool):int= function(b: bool): int { var n: int = 1; let x: int = branch when{(b)=>{n = 2; return n;},else=>{n = 3; n}}; n + x }; f(false) == 6"
              "let f :function(bool):int= function(b: bool): int { var n: int = 1; let x: int = branch when{(b)=>{n = 2; n},else=>{return 3;}}; n + x }; f(true) == 4"
              "let bad :function(int):int= function(n: int): int { 1 / n }; let f :function():int= function(): int { bad(branch when{(true)=>{return 8;},else=>{return 9;}}) }; f() == 8"))
    (v03-positive source :true))
  ;; All source functions remain present, but no call is emitted after a return.
  (let* ((module (native-ir "let bad :function(int):int= function(n: int): int { n / 0 }; let f :function():int= function(): int { bad(branch when{(true)=>{return 8;},else=>{return 9;}}) }; f() == 8"))
...
(deftest v04-reserved-words-and-grammar
  ...
  (dolist (source '( "let f :function(never):int= function(n: never): int { 1 }; true"
                    ...
                    "let f :function(int):int= function(n: int,): int { n }; true" "let f :function():int= function(): int { 1 }; f(1,) == 1"
...
(deftest v04-static-errors-and-cycles
  (dolist (source
            '("let f :function():int= function(): int { 1 }; let f :function(int):int= function(x: int): int { x }; true"
              "let g :function():int= function(): int { 1 }; let f :function(int):int= function(g: int): int { g }; true"
              "let f :function():int= function(): int { 1 }; let f = 2; true"
              "let f :function():int= function(): int { let f = 2; f }; true"
              "let f :function():int= function(): int { 1 }; branch when{(false)=>{var f = 1; true},else=>{true}}"
              "let f :function(int,int):int= function(x: int, x: int): int { x }; true"
              "let f :function(int):int= function(x: int): int { x = 1; x }; true"
              "let f :function(int):int= function(x: int): int { let x = 1; x }; true"
              "let f :function(int):int= function(x: int): int { branch when{(false)=>{let x = 2; x},else=>{x}} }; true"
              "let f :function():int= function(): int { x }; let x = 1; true"
              "let f :function():int= function(): int { let x: int = 1; x }; let g :function():int= function(): int { x }; true"
              "let f :function(int):int= function(x: int): int { x }; x == 1"
              "let f :function():int= function(): int { 1 }; f = 2; true"
              "let f: int = 1; f() == 1" "missing()" "let f :function():int= function(): int { 1 }; var saved :function():int= f; true"
              "let f :function(int):int= function(x: int): int { x }; f() == 1" "let f :function(int):int= function(x: int): int { x }; f(true) == 1"
              "let f :function():int= function(): int { true }; true" "let f :function():int= function(): int { return true; }; true"
              "let f :function():int= function(): int { branch when{(true)=>{return true;},else=>{1}} }; true"
              "let f :function():int= function(): int { branch when{(1)=>{return 1;},else=>{2}} }; true"
              "branch when{(true)=>{return true;},else=>{false}}"
              "let f :function():int= function(): int { let x = branch when{(true)=>{return 1;},else=>{return 2;}}; x }; true"
              "let f :function():int= function(): int { (branch when{(true)=>{return 1;},else=>{return 2;}}) + true }; true"
              "let f :function():int= function(): int { branch when{(branch when{(true)=>{return 1;},else=>{return 2;}})=>{1},else=>{true}} }; true"
              "let f :function():int= function(): int { var n: int = 0; n = branch when{(true)=>{return 1;},else=>{return 2;}}; true }; true"
              "let f :function():int= function(): int { var n: int = 0; n = branch when{(true)=>{return 1;},else=>{return 2;}}; missing }; true"
              "let f :function():int= function(): int { f() }; true"
              "let f :function():int= function(): int { g() }; let g :function():int= function(): int { f() }; true"
              "let f :function():int= function(): int { branch when{(false)=>{f()},else=>{1}} }; true"
              "let f :function():int= function(): int { var n: int = 1; n = branch when{(true)=>{return 1;},else=>{return 2;}}; f() }; true"
              "let f :function():int= function(): int { let x = x; x }; true"
              "let unused :function():int= function(): int { 9223372036854775808 }; true"))
    (v03-reject source "semantic")))

(deftest v04-call-runtime-order
  (dolist (pair '(("let f :function(int,int):int= function(a: int, b: int): int { 9223372036854775807 + 1 }; f(1 / 0, 1 % 0) == 0" "division by zero")
                  ("let f :function(int):int= function(a: int): int { 1 % 0 }; f(1) == 0" "remainder by zero")
                  ("let f :function():int= function(): int { return 9223372036854775807 + 1; }; f() == 0" "integer overflow")
                  ("let f :function():int= function(): int { 1 / 0 }; let unused: int = f(); true" "division by zero")
                  ("let f :function():int= function(): int { 1 % 0 }; let g :function():int= function(): int { f() + branch when{(true)=>{return 1;},else=>{return 2;}} }; g() == 0" "remainder by zero")))
...
(deftest v04-name-type-and-flow-boundaries
  ...
  (dolist (name '("Int" "Void" "never" "Unknown"))
    (v03-reject (format nil "let f:function(~A):int=function(n: ~A): int { 1 }; true" name name) "parse")
    (v03-reject (format nil "let f:function():~A=function(): ~A { 1 }; true" name name) "parse"))
...
(deftest v04-parameter-annotations
  (dolist (space (list "" " " (string #\Tab) (string #\Newline)
    ...
    (v03-positive
     (format nil "let choose:function(int,bool):int=function(n~A:~Aint, flag~A:~Abool): int { branch when{(flag)=>{n},else=>{0}} }; choose(7, true) == 7"
             space space space space)
     :true t))
  (v03-positive "let both :function(bool,bool):bool= function(left:bool,right:bool):bool { branch when{(left)=>{right},else=>{false}} }; both(true,false)"
                :false t)
  (let* ((text (format nil "let f:function(int,bool):int=function(~%  value : int,~%  flag: bool~%): int { branch when{(flag)=>{value},else=>{0}} }; f(7,true) == 7"))
  ...
  (dolist (text '("let f = function(int x): int { x }; true"
                  ...
                  "let f :function(int):int= function(: int): int { 1 }; true"
                  "let f :function():int= function(x:): int { x }; true"
                  "let f = function(x:: int): int { x }; true"
                  "let f = function(x: int, flag bool): int { x }; true"
                  "let f :function(int):int= function(x: int): int { x }; f(x: 1) == 1"))
    (v03-reject text "parse"))
  (dolist (case (list
                 (list "let f = function(int x): int { x }; true" 1 18)
                 (list "let f = function(x int): int { x }; true" 1 20)
                 (list "let f :function(int):int= function(: int): int { 1 }; true" 1 36)
                 (list "let f :function():int= function(x:): int { x }; true" 1 35)
  ...
  (let ((diag (diagnostic-of (lambda () (check-program (parse-text "let f :function(Int):int= function(x: Int): int { x }; true"))))))
    (same :semantic (diagnostic-phase diag)) (same 1 (diagnostic-line diag)) (same 39 (diagnostic-column diag)))
  (let* ((text "let f :function(int,bool):int= function(x: int, x: bool): int { x }; true")
         (diag (diagnostic-of (lambda () (check-program (parse-text text))))))
    (same :semantic (diagnostic-phase diag))
    (same 1 (diagnostic-line diag))
    (same 49 (diagnostic-column diag))))
