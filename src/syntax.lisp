...
(defstruct generic-signature-syntax (type-parameters #() :read-only t) (parameters #() :read-only t)
  (result nil :read-only t) (span nil :read-only t))
...
(defun form-span (form)
  (cond ((typep form 'function-type-syntax) (function-type-syntax-span form))
        ((typep form 'generic-signature-syntax) (generic-signature-syntax-span form))
